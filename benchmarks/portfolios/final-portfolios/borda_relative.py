...
mean-time, best-status, best-objective row from combined_avg.csv. Per-instance
ceiling is 2 (beats both others); total ceiling is 2 * n_instances.
...
def main():
    ...
    # totals[portfolio][year] += borda points
