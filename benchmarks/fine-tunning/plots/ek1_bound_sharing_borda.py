#!/usr/bin/env python3
"""Generate a Typst/Lilaq plot comparing Borda scores across bound-sharing intervals (ek1-8c-8s-v2)."""
...
OUTPUT_FILE = Path(__file__).resolve().parent / "ek1_bound_sharing_borda.typ"

CONFIGS = [
    ("none", "ek1-8c-8s-v2-bound-sharing-2025-none"),
    ("2s",   "ek1-8c-8s-v2-bound-sharing-2025-2s"),
    ("4s",   "ek1-8c-8s-v2-bound-sharing-2025-4s"),
    ("8s",   "ek1-8c-8s-v2-bound-sharing-2025-8s"),
    ("16s",  "ek1-8c-8s-v2-bound-sharing-2025-16s"),
    ("32s",  "ek1-8c-8s-v2-bound-sharing-2025-32s"),
    ("64s",  "ek1-8c-8s-v2-bound-sharing-2025-64s"),
    ("96s",  "ek1-8c-8s-v2-bound-sharing-2025-96s"),
    ("128s", "ek1-8c-8s-v2-bound-sharing-2025-128s"),
    ("160s", "ek1-8c-8s-v2-bound-sharing-2025-160s"),
    ("192s", "ek1-8c-8s-v2-bound-sharing-2025-192s"),
    ("224s", "ek1-8c-8s-v2-bound-sharing-2025-224s"),
    ("256s", "ek1-8c-8s-v2-bound-sharing-2025-256s"),
]
...
def main():
    ...
    print("Borda scores by bound-sharing interval (ek1-8c-8s-v2):")
