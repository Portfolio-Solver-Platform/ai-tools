#!/usr/bin/env python3
"""
Borda scores for ek1-8c-8s-v2 bound-sharing configs vs. all solvers from combined.csv (2025).
...
OUTPUT_FILE = Path(__file__).resolve().parent / "ek1_combined_borda_2025.typ"
YEAR = "2025"
