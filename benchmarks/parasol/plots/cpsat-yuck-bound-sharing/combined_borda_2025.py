#!/usr/bin/env python3
"""
Borda scores for bound-sharing configs competing against all solvers from combined.csv (2025).
...
CONFIGS = [
    ...
    ("64s", "cpsat-yuck-bound-sharing-2025-64s"),

]

BS_LABELS = {label for label, _ in CONFIGS}
...
def main():
    ...
    # Pairwise scoring across all solvers
    ...
    # Extract only bound-sharing scores, in config order
