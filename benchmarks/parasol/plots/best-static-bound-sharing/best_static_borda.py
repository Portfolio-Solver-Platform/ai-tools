#!/usr/bin/env python3
"""Generate a Typst/Lilaq plot comparing Borda scores across bound-sharing intervals (best-static portfolio)."""
...
def main():
    ...
    print("Borda scores by bound-sharing interval (best-static):")
    ...
    # Zoom y-axis onto the range where the scores actually differ.
