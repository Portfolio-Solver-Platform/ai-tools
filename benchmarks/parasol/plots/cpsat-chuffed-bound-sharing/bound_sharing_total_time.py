#!/usr/bin/env python3
"""Generate a Typst/Lilaq plot showing time saved by bound-sharing interval vs. no sharing (cpsat-chuffed)."""
...
BASELINE = ("none", "cpsat-chuffed-bound-sharing-2025-none")
INTERVALS = [
    (2,   "cpsat-chuffed-bound-sharing-2025-2s"),
    (4,   "cpsat-chuffed-bound-sharing-2025-4s"),
    (8,   "cpsat-chuffed-bound-sharing-2025-8s"),
    (16,  "cpsat-chuffed-bound-sharing-2025-16s"),
    (32,  "cpsat-chuffed-bound-sharing-2025-32s"),
    (64,  "cpsat-chuffed-bound-sharing-2025-64s"),
    (300, "cpsat-chuffed-bound-sharing-2025-300s"),
]
...
#lq.diagram(
  width: 10cm,
  height: 6cm,
  title: [Time Saved vs.\\ No Bound Sharing (cp-sat + chuffed, baseline: {baseline_s:,.0f}s)],
  ylabel: [Time saved (s)],
  ...
  lq.plot(({xs[0]}, {xs[-1]}), (0, 0), stroke: (dash: "dashed", paint: black)),
