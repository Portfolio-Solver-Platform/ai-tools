#!/usr/bin/env python3
"""Generate a Typst/Lilaq plot showing time saved by bound-sharing interval vs. no sharing (best-static, new run)."""
...
INTERVALS = [
    ...
    (128, "best-static-bound-sharing-2025-128s"),
    (256, "best-static-bound-sharing-2025-256s"),
    (512, "best-static-bound-sharing-2025-512s"),
]
