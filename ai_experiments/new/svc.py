"""
Minimal SVC baseline: train on 2011-2020 (10 years), test on 2021-2025.

No HPO, no CV — single fit, single test. sklearn defaults except for the
StandardScaler (essential for RBF SVM). Useful as a sanity-check reference
against the nested-CV results.
"""
import sys
...
TRAIN_THROUGH = 2024   # train on years <= this, test on years > this
